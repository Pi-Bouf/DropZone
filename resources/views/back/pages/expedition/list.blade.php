                ...
                <table class="table table-hover">
                    ...
                    @foreach($expeditions as $expedition)
                        <tr>
                            ...
                            <td>@if($expedition->isAccepted) <span class="badge bg-green">Accepté</span> @else <span class="badge bg-blue">En attente</span> @endif
                        </tr>
                    @endforeach
                    </tbody>
                </table>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <table class="table table-striped">
                    ...
                    <tr>
                        <td>Accepté</td>
                        <td>{{ Expedition::accepted()->count() }}</td>
                    </tr>
                    <tr>
                        <td>En attebte</td>
                        <td>{{ Expedition::waiting()->count() }}</td>
                    </tr>
                    <tr>
                        <td>Total</td>
